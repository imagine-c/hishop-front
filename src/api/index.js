...
export const forget = (params) => {
  return http.fetchPost('/member/forget', params)
}
// 发送验证码
export const code = (params) => {
  return http.fetchGet('/member/code', params)
}
// 邮箱激活
export const active = (params) => {
  return http.fetchGet('/member/active', params)
}
// 上传图片
export const upload = (params) => {
  return http.fetchPost('/member/imageUpload', params)
}
// 修改头像
