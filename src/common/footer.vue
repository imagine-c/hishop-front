    ...
    <div class="container">
      <div class="siteinfo">
        ...
        <ul class="c0">
          <h3 class="c1">友情链接</h3>
          <ul>
            <li class="c2"><a class="c3">测试</a></li>
            <li class="c2"><a class="c3">测试</a></li>
            <li class="c2"><a class="c3">Vue</a></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">关注我吧</h3>
          <ul>
            ...
            <li class="c2"><a class="c3" target="_blank" href="mailto:1069199309@qq.com">官方邮箱</a></li>
          </ul>
        </ul>

        <ul class="c4">
          <li class="tel"><a class="c5" href="http://wpa.qq.com/msgrd?v=3&uin=1069199309&site=qq&menu=yes" target="_blank">1069199309</a></li>
      ...
      <div class="copyright">
        <h4 class="content-c2">Copyright ©2019, hishop.cn Co., Ltd. All Rights Reserved.本网站设计内容大部分属锤子科技</h4>
        <ul class="privacy">
      ...
      <div class="cop">
        <a class="content-c3" href="http://www.miibeian.gov.cn/" target="_blank">
          <span class="content-c3">erwe</span>
          <span class="content-c3">qwew</span>
        </a>
      </div>
    </div>
  </div>
