                ...
                <div class="cart-group divide pr" :data-productid="item.productId">
                  <div class="cart-top-items">
                    <div class="cart-items clearfix">
                      ...
                      <div>
                        <!--总价格-->
                        <div class="subtotal" style="font-size: 14px">¥ {{((item.salePrice * 100) * (item.productNum * 100)) / 10000}}</div>
                        <!--数量-->
  ...
  export default {
    ...
    computed: {
      ...
      checkPrice () {
        ...
        this.cartList && this.cartList.forEach(item => {
          if (item.checked === '1') {
            totalPrice = ((totalPrice * 100) + ((item.salePrice * 100) * (item.productNum * 100)) / 100)
