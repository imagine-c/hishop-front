        ...
        <div v-if="loginPage" class="content">
          <ul class="common-form">
            ...
            <li style="text-align: right" class="pr">
              ...
              <a href="javascript:;" class="register" @click="toHome">去购物</a>
              <a href="javascript:;" class="register" @click="toRegister">去注册</a>
              <a style="padding: 1px 0 0 10px" @click="toForget">忘记密码 ?</a>
            </li>
          </ul>
          <!--登陆-->
